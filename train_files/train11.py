...
LAMBDA1, LAMBDA2 = 1, 2e1  # Weight of the sparsity, Weight of the largest coeffs
...
WORKING_DIR = join("output_dirs", "train_11")
...
def train(train_id: int):
    ...
    model = PolynomialSearch(degree=DEGREE, deg_q=GUESSED_DEG_Q).to(DEVICE)
    ...
    model = EfficientPolynomialSearch(degree=DEGREE, deg_q=GUESSED_DEG_Q).to(DEVICE)
